...
class Generator:
    ...
    def processWords(self):
        with open('corpusNews.txt',encoding="latin-1") as file:
...
oneWordPair = machine.load_obj("oneWordPairNews")
twoWordPair = machine.load_obj("twoWordPairNews")
threeWordPair = machine.load_obj("threeWordPairNews")
fourWordPair = machine.load_obj("fourWordPairNews")

twoWordProb = machine.load_obj("twoWordProbNews")
threeWordProb = machine.load_obj("threeWordProbNews")
fourWordProb = machine.load_obj("fourWordProbNews")
