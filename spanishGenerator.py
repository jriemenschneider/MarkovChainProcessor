...
class Generator:
    ...
    def processWords(self):
        with open('corpusSpanish.txt',encoding="latin-1") as file:
...
oneWordPair = machine.load_obj("oneWordPairSpanish")
twoWordPair = machine.load_obj("twoWordPairSpanish")
threeWordPair = machine.load_obj("threeWordPairSpanish")
fourWordPair = machine.load_obj("fourWordPairSpanish")

twoWordProb = machine.load_obj("twoWordProbSpanish")
threeWordProb = machine.load_obj("threeWordProbSpanish")
fourWordProb = machine.load_obj("fourWordProbSpanish")
